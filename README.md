...
|                                                                                                                                                                                                                                                                                                                                BRGV-OS is installed                                                                                                                                                                                                                                                                                                                                  |                         on full encrypted mode on multiple physical disks and logical volumes (LUKS and LVM)                         |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|
| Source: `Local`</br><br/>VG0: `sda2`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `8`</br>LVROTFS (%): `100`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0`</br><br/>VG1: `sda3`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `100`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0`</br><br/>VG2: `sdb1`+`sdc1`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `100`</br><br/>VG3: `sdb2`+`sdd1`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `100`</br>LVEXTRA-2 (%): `0`</br><br/>Filesystems: `btrfs` | [<img src="https://img.youtube.com/vi/PeSIfbE2e6o/maxresdefault.jpg"/>](https://www.youtube.com/embed/PeSIfbE2e6o?autoplay=1&mute=1) |
