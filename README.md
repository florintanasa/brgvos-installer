...
|          <sub>crypt_0</br>`sda4`</sub>          |            <sub>crypt_1 </br>`sdb1`</sub>            |           <sub>crypt_2</br>`sdc1`</sub>            |                 <sub>crypt_2</br>`sdd1`</sub>                  | <sub>BRGV-OS is installed on not full encrypted mode</br>on multiple physical disks and LV,</br> because /boot and swap is not encrypted</sub>            |
|:-----------------------------------------------:|:----------------------------------------------------:|:--------------------------------------------------:|:--------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------|
