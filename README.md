...
|                                                             VG0: `sda2`                                                              |                                                             VG1: `sda3`                                                              |                                                          VG2: `sdb1`+`sdc1`                                                          |                                                          VG3: `sdb2`+`sdd1`                                                          |              BRGV-OS is installed on full encrypted mode on multiple physical disks and logical volumes (LUKS and LVM)               |
|:------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|
| LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `8`</br>LVROTFS (%): `100`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0` | LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `100`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0` | LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `100` | LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `100`</br>LVEXTRA-2 (%): `0` | [<img src="https://img.youtube.com/vi/PeSIfbE2e6o/maxresdefault.jpg"/>](https://www.youtube.com/embed/PeSIfbE2e6o?autoplay=1&mute=1) |
