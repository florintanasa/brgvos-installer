...
|                                                           <sub>VG0: </br>`sda4`</sub>                                                           |                                                        <sub>VG1: </br>`sdb1`+`sdc1`</sub>                                                        |                                                        <sub>VG2: </br>`sdb2`+`sdd1`</sub>                                                        |              <sub>BRGV-OS is installed on not full encrypted mode,</br>because /boot and swap is not encrypted,</br>without using LVM</sub>               |
|:-----------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <sub>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `100`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0`</sub> | <sub> LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `100`</sub> | <sub>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `100` </sub> | [<img src="https://img.youtube.com/vi/5T8wprxRB90/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/5T8wprxRB90?autoplay=1&mute=1) |


|          <sub>crypt_0</br>`sda4`</sub>          |            <sub>crypt_1 </br>`sdb1`</sub>            |           <sub>crypt_2</br>`sdc1`</sub>            |                 <sub>crypt_3</br>`sdd1`</sub>                  | <sub>BRGV-OS is installed on not full encrypted mode</br>on multiple physical disks and LV,</br> because /boot and swap is not encrypted</sub>            |
|:-----------------------------------------------:|:----------------------------------------------------:|:--------------------------------------------------:|:--------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <sub>LVM&LUKS: `LUKS`</br>Mounting in `/`</sub> | <sub> LVM&LUKS: `LUKS`</br>Mounting in `/home`</sub> | <sub>LVM&LUKS: `LUKS`</br>Mounting in `/srv`</sub> | <sub>LVM&LUKS: `LUKS`</br>Mounting in `/var/lib/libvirt`</sub> | [<img src="https://img.youtube.com/vi/wnzX56Ds1E4/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/wnzX56Ds1E4?autoplay=1&mute=1) |

|                                                       <sub>VG0: </br>`sda2`+`sdb1`</sub>                                                        |                                                           <sub>VG1: </br>`sdc1`</sub>                                                            |                                                           <sub>VG2: </br>`sdd1`</sub>                                                            |                                          <sub>BRGV-OS is installed on</br>multiple physical disks and LVM</sub>                                           |
|:-----------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <sub>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `9`</br>LVROTFS (%): `30`</br>LVHOME (%): `70`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `0`</sub> | <sub> LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `100`</br>LVEXTRA-2 (%): `0`</sub> | <sub>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `0`</br>LVHOME (%): `0`</br>LVEXTRA-1 (%): `0`</br>LVEXTRA-2 (%): `100` </sub> | [<img src="https://img.youtube.com/vi/1E2chgi6-XM/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/1E2chgi6-XM?autoplay=1&mute=1) |

Next videos are for only one volume group, before to add possibility to install on multi volume group but in many occasion is used.

|                                                                 <sub>VG0                                                                 |                                                         <sub>BRGV-OS install on LVM in HDD</sub>                                                          |                                                                    <sub>VG0                                                                     |                                                    <sub>BRGV-OS install in SSD encrypted and LVM</sub>                                                    |
|:----------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <sub>Source: `Local`</br>LVM&LUKS: `LVM`</br>LVSWAP (GB): `14`</br>LVROTFS (%): `30`</br>LVHOME (%): `70`</br>Filesystems: `btrfs`</sub> | [<img src="https://img.youtube.com/vi/8uVmGKrpThI/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/8uVmGKrpThI?autoplay=1&mute=1) | <sub>Source: `Local`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `14`</br>LVROTFS (%): `30`</br>LVHOME (%): `60`</br>Filesystems: `btrfs`</sub> | [<img src="https://img.youtube.com/vi/bk30gESYeJU/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/bk30gESYeJU?autoplay=1&mute=1) |


|                                                                       |                                               <sub>BRGV-OS install on tty console</br>in SSD and HDD</sub>                                                |                                                                    <sub>VG0                                                                    |                                                   <sub>BRGV-OS install in not full encrypted mode</sub>                                                   |
|:---------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <sub>Source: `Local`</br>LVM&LUKS: `NO`</br>Filesystems: `ext4`</sub> | [<img src="https://img.youtube.com/vi/dD8Q4JN7lYw/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/dD8Q4JN7lYw?autoplay=1&mute=1) | <sub>Source: `Local`</br>LVM&LUKS: `LVM`+`LUKS`</br>LVSWAP (GB): `6`</br>LVROTFS (%): `30`</br>LVHOME (%): `60`</br>Filesystems: `btrfs`</sub> | [<img src="https://img.youtube.com/vi/7Jb-8-Kc6YM/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/7Jb-8-Kc6YM?autoplay=1&mute=1) |


|                                                                 <sub>VG0                                                                  |                                              <sub>Void Linux install with brgvos-installer</br>on LVM</sub>                                               |
|:-----------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <sub>Source: `Network`</br>LVM&LUKS: `LVM`</br>LVSWAP (GB): `0`</br>LVROTFS (%): `30`</br>LVHOME (%): `70`</br>Filesystems: `btrfs`</sub> | [<img src="https://img.youtube.com/vi/x9IMfU4ZXuw/maxresdefault.jpg" width=250 height=150/>](https://www.youtube.com/embed/x9IMfU4ZXuw?autoplay=1&mute=1) |
